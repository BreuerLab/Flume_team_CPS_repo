...
#ifndef RTW_HEADER_CPS_Eva_h_
#define RTW_HEADER_CPS_Eva_h_
#ifndef CPS_Eva_COMMON_INCLUDES_
#define CPS_Eva_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#define CPS_Eva_rtModel                RT_MODEL_CPS_Eva_T
...
#define rtB                            CPS_Eva_B
#define BlockIO                        B_CPS_Eva_T
#define rtX                            CPS_Eva_X
#define ContinuousStates               X_CPS_Eva_T
#define rtXdot                         CPS_Eva_XDot
#define StateDerivatives               XDot_CPS_Eva_T
#define tXdis                          CPS_Eva_XDis
#define StateDisabled                  XDis_CPS_Eva_T
#define rtP                            CPS_Eva_P
#define Parameters                     P_CPS_Eva_T
#define rtDWork                        CPS_Eva_DW
#define D_Work                         DW_CPS_Eva_T
...
struct P_CPS_Eva_T_ {
  ...
  real_T Constant4_Value;              /* Expression: 0.5
                                        ...
                                        */
  real_T Gain10_Gain;          /* Expression: -5.*10/30000*12800/360*1.00*180/pi
  ...
  uint32_T AnalogFilterDesign_C_jc[5];
                                   ...
                                   * Referenced by: '<Root>/Analog Filter Design'
                                   */
  uint8_T Sineorcustomtrajectory_CurrentSetting;
  ...
  uint8_T CPSorReference_CurrentSetting;
                             ...
                             */
  uint8_T zeropitchorconstant_CurrentSetting;
...
extern P_CPS_Eva_T CPS_Eva_P;

/* Block signals (default storage) */
extern B_CPS_Eva_T CPS_Eva_B;

/* Continuous states (default storage) */
extern X_CPS_Eva_T CPS_Eva_X;

/* Block states (default storage) */
extern DW_CPS_Eva_T CPS_Eva_DW;

/* Model entry point functions */
extern void CPS_Eva_initialize(void);
extern void CPS_Eva_output(void);
extern void CPS_Eva_update(void);
extern void CPS_Eva_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern CPS_Eva_rtModel *CPS_Eva(void);
...
extern RT_MODEL_CPS_Eva_T *const CPS_Eva_M;
