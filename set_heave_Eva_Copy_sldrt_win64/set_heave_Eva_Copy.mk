...
MODEL                := set_heave_Eva_Copy
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c set_heave_Eva_Copy_data.c set_heave_Eva_Copy_tgtconn.c
MAKEFILE             := set_heave_Eva_Copy.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := set_heave_Eva_Copy_ref.rsp
...
# additional includes
REQ_INCLUDES += ;R:/ENG_Breuer_Shared/eericks1/Flume_team_CPS_repo;R:/ENG_Breuer_Shared/eericks1/Flume_team_CPS_repo/set_heave_Eva_Copy_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
