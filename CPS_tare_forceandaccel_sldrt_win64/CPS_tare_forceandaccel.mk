...
MODEL                := CPS_tare_forceandaccel
MODULES              := CPS_tare_forceandaccel_data.c CPS_tare_forceandaccel_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := CPS_tare_forceandaccel.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := CPS_tare_forceandaccel_ref.rsp
...
# additional includes
REQ_INCLUDES += ;R:/ENG_Breuer_Shared/eericks1/Flume_team_CPS_repo;R:/ENG_Breuer_Shared/eericks1/Flume_team_CPS_repo/CPS_tare_forceandaccel_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
