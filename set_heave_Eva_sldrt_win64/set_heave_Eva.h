 ...
 * C source code generated on : Sun Mar  5 21:45:38 2023
 *
...
#ifndef RTW_HEADER_set_heave_Eva_h_
#define RTW_HEADER_set_heave_Eva_h_
#ifndef set_heave_Eva_COMMON_INCLUDES_
#define set_heave_Eva_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* set_heave_Eva_COMMON_INCLUDES_ */

#include "set_heave_Eva_types.h"
#include "rtGetInf.h"
#include <stddef.h>
...
#define set_heave_Eva_rtModel          RT_MODEL_set_heave_Eva_T
...
#define rtB                            set_heave_Eva_B
#define BlockIO                        B_set_heave_Eva_T
#define rtP                            set_heave_Eva_P
#define Parameters                     P_set_heave_Eva_T
#define rtDWork                        set_heave_Eva_DW
#define D_Work                         DW_set_heave_Eva_T
...
struct P_set_heave_Eva_T_ {
  ...
  real_T SineWave1_Bias;               /* Expression: 0
                                        * Referenced by: '<Root>/Sine Wave1'
                                        */
  real_T SineWave1_Freq;               /* Expression: 2*3.14*(1/(2*7))
                                        * Referenced by: '<Root>/Sine Wave1'
                                        */
...
struct tag_RTM_set_heave_Eva_T {
  const char_T *path;
...
extern P_set_heave_Eva_T set_heave_Eva_P;

/* Block signals (default storage) */
extern B_set_heave_Eva_T set_heave_Eva_B;

/* Block states (default storage) */
extern DW_set_heave_Eva_T set_heave_Eva_DW;

/* Model entry point functions */
extern void set_heave_Eva_initialize(void);
extern void set_heave_Eva_output(void);
extern void set_heave_Eva_update(void);
extern void set_heave_Eva_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern set_heave_Eva_rtModel *set_heave_Eva(void);
...
extern RT_MODEL_set_heave_Eva_T *const set_heave_Eva_M;
 ...
 * '<Root>' : 'set_heave_Eva'
 */
#endif                                 /* RTW_HEADER_set_heave_Eva_h_ */
