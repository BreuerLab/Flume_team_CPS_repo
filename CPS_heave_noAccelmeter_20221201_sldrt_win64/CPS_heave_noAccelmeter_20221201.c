/*
 * CPS_heave_noAccelmeter_20221201.c
 *
...
#include <math.h>
#include <emmintrin.h>
#include "CPS_heave_noAccelmeter_20221201_private.h"
#include <string.h>
#include "rt_nonfinite.h"
#include "CPS_heave_noAccelmeter_20221201_dt.h"
...
B_CPS_heave_noAccelmeter_20221201_T CPS_heave_noAccelmeter_20221201_B;

/* Continuous states */
X_CPS_heave_noAccelmeter_20221201_T CPS_heave_noAccelmeter_20221201_X;

/* Block states (default storage) */
DW_CPS_heave_noAccelmeter_20221201_T CPS_heave_noAccelmeter_20221201_DW;

/* Real-time model */
static RT_MODEL_CPS_heave_noAccelmeter_20221201_T
  CPS_heave_noAccelmeter_20221201_M_;
RT_MODEL_CPS_heave_noAccelmeter_20221201_T *const
  CPS_heave_noAccelmeter_20221201_M = &CPS_heave_noAccelmeter_20221201_M_;
...
static void rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
  ...
  /* f0 = f(t,y) */
  rtsiSetdX(si, f0);
  CPS_heave_noAccelmeter_20221201_derivatives();
  ...
  rtsiSetT(si, t + temp);
  rtsiSetdX(si, f1);
  CPS_heave_noAccelmeter_20221201_output();
  CPS_heave_noAccelmeter_20221201_derivatives();
...
void CPS_heave_noAccelmeter_20221201_output(void)
{
  /* local block i/o variables */
  real_T rtb_FromWs;
  __m128d tmp_0;
  real_T tmp[36];
  real_T rtb_AnalogInput1[9];
  real_T rtb_AnalogInput1_0[6];
  ...
  int32_T i_0;
  uint32_T ri;
  if (rtmIsMajorTimeStep(CPS_heave_noAccelmeter_20221201_M)) {
    /* set solver stop time */
    if (!(CPS_heave_noAccelmeter_20221201_M->Timing.clockTick0+1)) {
      rtsiSetSolverStopTime(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                            ((CPS_heave_noAccelmeter_20221201_M->Timing.clockTickH0
        + 1) * CPS_heave_noAccelmeter_20221201_M->Timing.stepSize0 *
        4294967296.0));
    } else {
      rtsiSetSolverStopTime(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                            ((CPS_heave_noAccelmeter_20221201_M->Timing.clockTick0
        + 1) * CPS_heave_noAccelmeter_20221201_M->Timing.stepSize0 +
        CPS_heave_noAccelmeter_20221201_M->Timing.clockTickH0 *
        CPS_heave_noAccelmeter_20221201_M->Timing.stepSize0 * 4294967296.0));
    }
  }                                    /* end MajorTimeStep */

  /* Update absolute time of base rate at minor time step */
  if (rtmIsMinorTimeStep(CPS_heave_noAccelmeter_20221201_M)) {
    CPS_heave_noAccelmeter_20221201_M->Timing.t[0] = rtsiGetT
      (&CPS_heave_noAccelmeter_20221201_M->solverInfo);
  }

  if (rtmIsMajorTimeStep(CPS_heave_noAccelmeter_20221201_M)) {
    /* Constant: '<Root>/Virtual damping (kg//s)' */
    CPS_heave_noAccelmeter_20221201_B.Virtualdampingkgs =
      CPS_heave_noAccelmeter_20221201_P.c;

    /* Constant: '<Root>/Virtual spring (N//m)' */
    CPS_heave_noAccelmeter_20221201_B.VirtualspringNm =
      CPS_heave_noAccelmeter_20221201_P.k;
  }

  /* StateSpace: '<Root>/Analog Filter Design' */
  CPS_heave_noAccelmeter_20221201_B.LateralforcefilteredN = 0.0;

  /* StateSpace: '<Root>/Analog Filter Design' */
  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_jc[0U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_jc[1U]; ri++) {
    /* StateSpace: '<Root>/Analog Filter Design' */
    CPS_heave_noAccelmeter_20221201_B.LateralforcefilteredN +=
      CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_pr *
      CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[0U];
  }

  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_jc[1U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_jc[2U]; ri++) {
    /* StateSpace: '<Root>/Analog Filter Design' */
    CPS_heave_noAccelmeter_20221201_B.LateralforcefilteredN +=
      CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_pr *
      CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[1U];
  }

  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_jc[2U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_jc[3U]; ri++) {
    /* StateSpace: '<Root>/Analog Filter Design' */
    CPS_heave_noAccelmeter_20221201_B.LateralforcefilteredN +=
      CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_pr *
      CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[2U];
  }

  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_jc[3U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_jc[4U]; ri++) {
    /* StateSpace: '<Root>/Analog Filter Design' */
    CPS_heave_noAccelmeter_20221201_B.LateralforcefilteredN +=
      CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_C_pr *
      CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[3U];
  }
  ...
  /* Gain: '<Root>/inverse  mass (1//kg) ' incorporates:
   *  Sum: '<Root>/Sum'
   */
  CPS_heave_noAccelmeter_20221201_B.inversemass1kg = 1.0 /
    CPS_heave_noAccelmeter_20221201_P.M *
    (CPS_heave_noAccelmeter_20221201_B.LateralforcefilteredN -
     CPS_heave_noAccelmeter_20221201_B.UnitDelay);
  if (rtmIsMajorTimeStep(CPS_heave_noAccelmeter_20221201_M)) {
    /* DiscreteIntegrator: '<Root>/Integrator' */
    if (CPS_heave_noAccelmeter_20221201_DW.Integrator_SYSTEM_ENABLE != 0) {
      /* DiscreteIntegrator: '<Root>/Integrator' */
    ...
    /* DiscreteIntegrator: '<Root>/Integrator 2' */
    if (CPS_heave_noAccelmeter_20221201_DW.Integrator2_SYSTEM_ENABLE != 0) {
      /* DiscreteIntegrator: '<Root>/Integrator 2' */
    ...
    /* End of DiscreteIntegrator: '<Root>/Integrator 2' */
  }

  /* FromWorkspace: '<S1>/FromWs' */
  {
    real_T *pDataValues = (real_T *)
      CPS_heave_noAccelmeter_20221201_DW.FromWs_PWORK.DataPtr;
    real_T *pTimeValues = (real_T *)
      CPS_heave_noAccelmeter_20221201_DW.FromWs_PWORK.TimePtr;
    int_T currTimeIndex =
      CPS_heave_noAccelmeter_20221201_DW.FromWs_IWORK.PrevIndex;
    real_T t = CPS_heave_noAccelmeter_20221201_M->Timing.t[0];
    ...
    CPS_heave_noAccelmeter_20221201_DW.FromWs_IWORK.PrevIndex = currTimeIndex;
   ...
   */
  if (CPS_heave_noAccelmeter_20221201_P.CPSorreference_CurrentSetting == 1) {
    rtb_CPSorreference = CPS_heave_noAccelmeter_20221201_B.Integrator2;
  } else if (CPS_heave_noAccelmeter_20221201_P.signalorzero_CurrentSetting == 1)
  {
    /* ManualSwitch: '<Root>/sine or custom traj.' incorporates:
     *  ManualSwitch: '<Root>/signal or zero'
     *  Sin: '<Root>/Sine Wave'
     */
    if (CPS_heave_noAccelmeter_20221201_P.sineorcustomtraj_CurrentSetting == 1)
    {
      rtb_CPSorreference = sin(CPS_heave_noAccelmeter_20221201_P.SineWave_Freq *
        CPS_heave_noAccelmeter_20221201_M->Timing.t[0] +
    ...
    /* End of ManualSwitch: '<Root>/sine or custom traj.' */
  } else {
    /* ManualSwitch: '<Root>/signal or zero' incorporates:
     *  Constant: '<Root>/Zero'
     */
    rtb_CPSorreference = CPS_heave_noAccelmeter_20221201_P.Zero_Value;
  }

  /* End of ManualSwitch: '<Root>/CPS or  reference' */

  /* Gain: '<Root>/position out  m to V' */
  CPS_heave_noAccelmeter_20221201_B.positionoutmtoV =
    CPS_heave_noAccelmeter_20221201_P.positionoutmtoV_Gain * rtb_CPSorreference;
  if (rtmIsMajorTimeStep(CPS_heave_noAccelmeter_20221201_M)) {
    /* ManualSwitch: '<Root>/Pitch zero or constant' */
    if (CPS_heave_noAccelmeter_20221201_P.Pitchzeroorconstant_CurrentSetting ==
        1) {
      /* ManualSwitch: '<Root>/Pitch zero or constant' incorporates:
       *  Constant: '<Root>/Zero'
       */
    ...
    /* End of ManualSwitch: '<Root>/Pitch zero or constant' */

    /* Gain: '<Root>/angle out deg1' */
    rtb_EncoderInput = CPS_heave_noAccelmeter_20221201_P.angleoutdeg1_Gain *
      CPS_heave_noAccelmeter_20221201_B.Pitchzeroorconstant;
    ...
    /* S-Function Block: <Root>/Analog Input1 */
    {
      ...
      parm.rangeidx = CPS_heave_noAccelmeter_20221201_P.AnalogInput1_VoltRange;
      RTBIO_DriverIO(0, ANALOGINPUT, IOREAD, 9,
    ...
    /* S-Function Block: <Root>/Encoder Input */
    {
      ...
      parm.infilter = CPS_heave_noAccelmeter_20221201_P.EncoderInput_InputFilter;
    ...
    /* S-Function Block: <Root>/Analog Input2 */
    {
      ...
      parm.rangeidx = CPS_heave_noAccelmeter_20221201_P.AnalogInput2_VoltRange;
    ...
    for (i = 0; i <= 4; i += 2) {
      /* Bias: '<Root>/force bias' */
      tmp_0 = _mm_loadu_pd(&rtb_AnalogInput1[i]);
      _mm_storeu_pd(&rtb_AnalogInput1_0[i], _mm_add_pd(tmp_0, _mm_loadu_pd
        (&CPS_heave_noAccelmeter_20221201_P.forcebias_Bias[i])));
    }

    for (i = 0; i <= 34; i += 2) {
      /* Gain: '<Root>/conversion  matrix' */
      _mm_storeu_pd(&tmp[i], _mm_mul_pd(_mm_loadu_pd
        (&CPS_heave_noAccelmeter_20221201_P.Wallace_Cal_tranp[i]), _mm_set1_pd
        (-1.0)));
    }

    for (i = 0; i < 6; i++) {
      /* Gain: '<Root>/conversion  matrix' */
      CPS_heave_noAccelmeter_20221201_B.conversionmatrix[i] = 0.0;
      for (i_0 = 0; i_0 < 6; i_0++) {
        CPS_heave_noAccelmeter_20221201_B.conversionmatrix[i] += tmp[6 * i + i_0]
          * rtb_AnalogInput1_0[i_0];
      }

      /* End of Gain: '<Root>/conversion  matrix' */
    }

    /* Gain: '<Root>/load mass' incorporates:
     *  Bias: '<Root>/accel bias (V)'
     *  Gain: '<Root>/accel V to m//s2'
     */
    CPS_heave_noAccelmeter_20221201_B.InertialloadN = (rtb_AnalogInput1[8] +
    ...
    /* SignalConversion generated from: '<Root>/Forces' */
    CPS_heave_noAccelmeter_20221201_B.TmpSignalConversionAtForcesInport1[0] =
      CPS_heave_noAccelmeter_20221201_B.conversionmatrix[5];
    CPS_heave_noAccelmeter_20221201_B.TmpSignalConversionAtForcesInport1[1] =
      CPS_heave_noAccelmeter_20221201_B.conversionmatrix[0];
    CPS_heave_noAccelmeter_20221201_B.TmpSignalConversionAtForcesInport1[2] =
      CPS_heave_noAccelmeter_20221201_B.conversionmatrix[1];
    CPS_heave_noAccelmeter_20221201_B.TmpSignalConversionAtForcesInport1[3] =
      CPS_heave_noAccelmeter_20221201_B.InertialloadN;
    CPS_heave_noAccelmeter_20221201_B.TmpSignalConversionAtForcesInport1[4] =
      CPS_heave_noAccelmeter_20221201_B.LateralforcefilteredN;

    /* Constant: '<Root>/Zero force' */
  ...
  CPS_heave_noAccelmeter_20221201_B.Prescribedheavecm =
    CPS_heave_noAccelmeter_20221201_P.cmm_Gain * rtb_CPSorreference;
  if (rtmIsMajorTimeStep(CPS_heave_noAccelmeter_20221201_M)) {
    /* Bias: '<Root>/initial position' incorporates:
     *  Gain: '<Root>/counts to cm'
     */
    CPS_heave_noAccelmeter_20221201_B.Encodermeasuredheavecm =
      CPS_heave_noAccelmeter_20221201_P.countstocm_Gain * rtb_EncoderInput +
      100.0 * CPS_heave_noAccelmeter_20221201_P.start_position_meters;

    /* Gain: '<Root>/Pitch V to rad' */
    CPS_heave_noAccelmeter_20221201_B.Pitchmeasuredrad =
      CPS_heave_noAccelmeter_20221201_P.PitchVtorad_Gain * rtb_AnalogInput1[6];

    /* Product: '<Root>/damping*speed' */
    CPS_heave_noAccelmeter_20221201_B.dampingspeed =
      CPS_heave_noAccelmeter_20221201_B.Integrator *
      CPS_heave_noAccelmeter_20221201_B.Virtualdampingkgs;

    /* Product: '<Root>/stiffness*displacement' incorporates:
     *  Constant: '<Root>/Heave offset'
     *  Sum: '<Root>/Sum3'
     */
  ...
  if (rtmIsMajorTimeStep(CPS_heave_noAccelmeter_20221201_M)) {
     ...
     *  Bias: '<Root>/Bias'
     */
    CPS_heave_noAccelmeter_20221201_B.conversion1[0] = (rtb_AnalogInput2[0] +
      CPS_heave_noAccelmeter_20221201_P.Bias_Bias) *
      CPS_heave_noAccelmeter_20221201_P.conversion1_Gain;
    CPS_heave_noAccelmeter_20221201_B.conversion1[1] = (rtb_AnalogInput2[1] +
      CPS_heave_noAccelmeter_20221201_P.Bias_Bias) *
      CPS_heave_noAccelmeter_20221201_P.conversion1_Gain;
    CPS_heave_noAccelmeter_20221201_B.conversion1[2] = (rtb_AnalogInput2[2] +
      CPS_heave_noAccelmeter_20221201_P.Bias_Bias) *
      CPS_heave_noAccelmeter_20221201_P.conversion1_Gain;
    CPS_heave_noAccelmeter_20221201_B.conversion1[3] = (rtb_AnalogInput2[3] +
      CPS_heave_noAccelmeter_20221201_P.Bias_Bias) *
      CPS_heave_noAccelmeter_20221201_P.conversion1_Gain;
  }
}
...
void CPS_heave_noAccelmeter_20221201_update(void)
{
  if (rtmIsMajorTimeStep(CPS_heave_noAccelmeter_20221201_M)) {
    ...
    CPS_heave_noAccelmeter_20221201_DW.Integrator_SYSTEM_ENABLE = 0U;
    CPS_heave_noAccelmeter_20221201_DW.Integrator_DSTATE =
      CPS_heave_noAccelmeter_20221201_P.Integrator_gainval *
      CPS_heave_noAccelmeter_20221201_B.inversemass1kg +
      CPS_heave_noAccelmeter_20221201_B.Integrator;

    /* Update for DiscreteIntegrator: '<Root>/Integrator 2' */
    CPS_heave_noAccelmeter_20221201_DW.Integrator2_SYSTEM_ENABLE = 0U;
    CPS_heave_noAccelmeter_20221201_DW.Integrator2_DSTATE =
      CPS_heave_noAccelmeter_20221201_P.Integrator2_gainval *
      CPS_heave_noAccelmeter_20221201_B.Integrator +
      CPS_heave_noAccelmeter_20221201_B.Integrator2;
   ...
   */
  if (!(++CPS_heave_noAccelmeter_20221201_M->Timing.clockTick0)) {
    ++CPS_heave_noAccelmeter_20221201_M->Timing.clockTickH0;
  }

  CPS_heave_noAccelmeter_20221201_M->Timing.t[0] = rtsiGetSolverStopTime
    (&CPS_heave_noAccelmeter_20221201_M->solverInfo);

  {
     ...
     */
    if (!(++CPS_heave_noAccelmeter_20221201_M->Timing.clockTick1)) {
      ++CPS_heave_noAccelmeter_20221201_M->Timing.clockTickH1;
    }

    CPS_heave_noAccelmeter_20221201_M->Timing.t[1] =
      CPS_heave_noAccelmeter_20221201_M->Timing.clockTick1 *
      CPS_heave_noAccelmeter_20221201_M->Timing.stepSize1 +
      CPS_heave_noAccelmeter_20221201_M->Timing.clockTickH1 *
      CPS_heave_noAccelmeter_20221201_M->Timing.stepSize1 * 4294967296.0;
  }
}

/* Derivatives for root system: '<Root>' */
void CPS_heave_noAccelmeter_20221201_derivatives(void)
{
  XDot_CPS_heave_noAccelmeter_20221201_T *_rtXdot;
  uint32_T ri;
  _rtXdot = ((XDot_CPS_heave_noAccelmeter_20221201_T *)
             CPS_heave_noAccelmeter_20221201_M->derivs);
  ...
  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_jc[0U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_jc[1U]; ri++) {
    _rtXdot->
      AnalogFilterDesign_CSTATE[CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_ir
      [ri]] += CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_pr[ri] *
      CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[0U];
  }

  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_jc[1U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_jc[2U]; ri++) {
    _rtXdot->
      AnalogFilterDesign_CSTATE[CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_ir
      [ri]] += CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_pr[ri] *
      CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[1U];
  ...
  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_jc[2U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_jc[3U]; ri++) {
    _rtXdot->
      AnalogFilterDesign_CSTATE[CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_ir
      [ri]] += CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_pr[ri] *
      CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[2U];
  ...
  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_jc[3U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_jc[4U]; ri++) {
    _rtXdot->
      AnalogFilterDesign_CSTATE[CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_ir
      [ri]] += CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_A_pr[ri] *
      CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[3U];
  ...
  for (ri = CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_B_jc[0U]; ri <
       CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_B_jc[1U]; ri++) {
    _rtXdot->
      AnalogFilterDesign_CSTATE[CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_B_ir]
...
void CPS_heave_noAccelmeter_20221201_initialize(void)
{
  /* Start for FromWorkspace: '<S1>/FromWs' */
  {
    ...
    CPS_heave_noAccelmeter_20221201_DW.FromWs_PWORK.TimePtr = (void *)
      pTimeValues0;
    CPS_heave_noAccelmeter_20221201_DW.FromWs_PWORK.DataPtr = (void *)
      pDataValues0;
    CPS_heave_noAccelmeter_20221201_DW.FromWs_IWORK.PrevIndex = 0;
  }
  ...
  CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[0] =
    CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_InitialCondition;
  CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[1] =
    CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_InitialCondition;
  CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[2] =
    CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_InitialCondition;
  CPS_heave_noAccelmeter_20221201_X.AnalogFilterDesign_CSTATE[3] =
    CPS_heave_noAccelmeter_20221201_P.AnalogFilterDesign_InitialCondition;
  ...
  /* InitializeConditions for DiscreteIntegrator: '<Root>/Integrator 2' */
  CPS_heave_noAccelmeter_20221201_DW.Integrator2_DSTATE =
    CPS_heave_noAccelmeter_20221201_P.start_position_meters;
  ...
  /* Enable for DiscreteIntegrator: '<Root>/Integrator' */
  CPS_heave_noAccelmeter_20221201_DW.Integrator_SYSTEM_ENABLE = 1U;

  /* Enable for DiscreteIntegrator: '<Root>/Integrator 2' */
  CPS_heave_noAccelmeter_20221201_DW.Integrator2_SYSTEM_ENABLE = 1U;
}

/* Model terminate function */
void CPS_heave_noAccelmeter_20221201_terminate(void)
{
...
{
  CPS_heave_noAccelmeter_20221201_update();
  UNUSED_PARAMETER(tid);
}
...
void MdlStart(void)
{
  CPS_heave_noAccelmeter_20221201_initialize();
}

void MdlTerminate(void)
{
  CPS_heave_noAccelmeter_20221201_terminate();
}

/* Registration function */
RT_MODEL_CPS_heave_noAccelmeter_20221201_T *CPS_heave_noAccelmeter_20221201(void)
{
  /* Registration code */
  ...
  CPS_heave_noAccelmeter_20221201_P.EncoderInput_InputFilter = rtInf;

  /* initialize real-time model */
  (void) memset((void *)CPS_heave_noAccelmeter_20221201_M, 0,
                sizeof(RT_MODEL_CPS_heave_noAccelmeter_20221201_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                          &CPS_heave_noAccelmeter_20221201_M->Timing.simTimeStep);
    rtsiSetTPtr(&CPS_heave_noAccelmeter_20221201_M->solverInfo, &rtmGetTPtr
                (CPS_heave_noAccelmeter_20221201_M));
    rtsiSetStepSizePtr(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                       &CPS_heave_noAccelmeter_20221201_M->Timing.stepSize0);
    rtsiSetdXPtr(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                 &CPS_heave_noAccelmeter_20221201_M->derivs);
    rtsiSetContStatesPtr(&CPS_heave_noAccelmeter_20221201_M->solverInfo, (real_T
      **) &CPS_heave_noAccelmeter_20221201_M->contStates);
    rtsiSetNumContStatesPtr(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
      &CPS_heave_noAccelmeter_20221201_M->Sizes.numContStates);
    rtsiSetNumPeriodicContStatesPtr
      (&CPS_heave_noAccelmeter_20221201_M->solverInfo,
       &CPS_heave_noAccelmeter_20221201_M->Sizes.numPeriodicContStates);
    rtsiSetPeriodicContStateIndicesPtr
      (&CPS_heave_noAccelmeter_20221201_M->solverInfo,
       &CPS_heave_noAccelmeter_20221201_M->periodicContStateIndices);
    rtsiSetPeriodicContStateRangesPtr
      (&CPS_heave_noAccelmeter_20221201_M->solverInfo,
       &CPS_heave_noAccelmeter_20221201_M->periodicContStateRanges);
    rtsiSetErrorStatusPtr(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                          (&rtmGetErrorStatus(CPS_heave_noAccelmeter_20221201_M)));
    rtsiSetRTModelPtr(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                      CPS_heave_noAccelmeter_20221201_M);
  }

  rtsiSetSimTimeStep(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                     MAJOR_TIME_STEP);
  CPS_heave_noAccelmeter_20221201_M->intgData.y =
    CPS_heave_noAccelmeter_20221201_M->odeY;
  CPS_heave_noAccelmeter_20221201_M->intgData.f[0] =
    CPS_heave_noAccelmeter_20221201_M->odeF[0];
  CPS_heave_noAccelmeter_20221201_M->intgData.f[1] =
    CPS_heave_noAccelmeter_20221201_M->odeF[1];
  CPS_heave_noAccelmeter_20221201_M->intgData.f[2] =
    CPS_heave_noAccelmeter_20221201_M->odeF[2];
  CPS_heave_noAccelmeter_20221201_M->intgData.f[3] =
    CPS_heave_noAccelmeter_20221201_M->odeF[3];
  CPS_heave_noAccelmeter_20221201_M->contStates = ((real_T *)
    &CPS_heave_noAccelmeter_20221201_X);
  rtsiSetSolverData(&CPS_heave_noAccelmeter_20221201_M->solverInfo, (void *)
                    &CPS_heave_noAccelmeter_20221201_M->intgData);
  rtsiSetIsMinorTimeStepWithModeChange
    (&CPS_heave_noAccelmeter_20221201_M->solverInfo, false);
  rtsiSetSolverName(&CPS_heave_noAccelmeter_20221201_M->solverInfo,"ode4");

  /* Initialize timing info */
  {
    int_T *mdlTsMap =
      CPS_heave_noAccelmeter_20221201_M->Timing.sampleTimeTaskIDArray;
    mdlTsMap[0] = 0;
    mdlTsMap[1] = 1;

    /* polyspace +2 MISRA2012:D4.1 [Justified:Low] "CPS_heave_noAccelmeter_20221201_M points to
       static memory which is guaranteed to be non-NULL" */
    CPS_heave_noAccelmeter_20221201_M->Timing.sampleTimeTaskIDPtr = (&mdlTsMap[0]);
    CPS_heave_noAccelmeter_20221201_M->Timing.sampleTimes =
      (&CPS_heave_noAccelmeter_20221201_M->Timing.sampleTimesArray[0]);
    CPS_heave_noAccelmeter_20221201_M->Timing.offsetTimes =
      (&CPS_heave_noAccelmeter_20221201_M->Timing.offsetTimesArray[0]);

    /* task periods */
    CPS_heave_noAccelmeter_20221201_M->Timing.sampleTimes[0] = (0.0);
    CPS_heave_noAccelmeter_20221201_M->Timing.sampleTimes[1] = (0.001);

    /* task offsets */
    CPS_heave_noAccelmeter_20221201_M->Timing.offsetTimes[0] = (0.0);
    CPS_heave_noAccelmeter_20221201_M->Timing.offsetTimes[1] = (0.0);
  }

  rtmSetTPtr(CPS_heave_noAccelmeter_20221201_M,
             &CPS_heave_noAccelmeter_20221201_M->Timing.tArray[0]);

  {
    int_T *mdlSampleHits =
      CPS_heave_noAccelmeter_20221201_M->Timing.sampleHitArray;
    mdlSampleHits[0] = 1;
    mdlSampleHits[1] = 1;
    CPS_heave_noAccelmeter_20221201_M->Timing.sampleHits = (&mdlSampleHits[0]);
  }

  rtmSetTFinal(CPS_heave_noAccelmeter_20221201_M, 10.0);
  CPS_heave_noAccelmeter_20221201_M->Timing.stepSize0 = 0.001;
...

  {
    ...
    CPS_heave_noAccelmeter_20221201_M->extModeInfo = (&rt_ExtModeInfo);
    rteiSetSubSystemActiveVectorAddresses(&rt_ExtModeInfo, systemRan);
    systemRan[0] = &rtAlwaysEnabled;
    systemRan[1] = &rtAlwaysEnabled;
    systemRan[2] = &rtAlwaysEnabled;
    systemRan[3] = &rtAlwaysEnabled;
    rteiSetModelMappingInfoPtr(CPS_heave_noAccelmeter_20221201_M->extModeInfo,
      &CPS_heave_noAccelmeter_20221201_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(CPS_heave_noAccelmeter_20221201_M->extModeInfo,
                        CPS_heave_noAccelmeter_20221201_M->Sizes.checksums);
    rteiSetTPtr(CPS_heave_noAccelmeter_20221201_M->extModeInfo, rtmGetTPtr
                (CPS_heave_noAccelmeter_20221201_M));
  }

  CPS_heave_noAccelmeter_20221201_M->solverInfoPtr =
    (&CPS_heave_noAccelmeter_20221201_M->solverInfo);
  CPS_heave_noAccelmeter_20221201_M->Timing.stepSize = (0.001);
  rtsiSetFixedStepSize(&CPS_heave_noAccelmeter_20221201_M->solverInfo, 0.001);
  rtsiSetSolverMode(&CPS_heave_noAccelmeter_20221201_M->solverInfo,
                    SOLVER_MODE_SINGLETASKING);

  /* block I/O */
  CPS_heave_noAccelmeter_20221201_M->blockIO = ((void *)
    &CPS_heave_noAccelmeter_20221201_B);
  (void) memset(((void *) &CPS_heave_noAccelmeter_20221201_B), 0,
                sizeof(B_CPS_heave_noAccelmeter_20221201_T));

  /* parameters */
  CPS_heave_noAccelmeter_20221201_M->defaultParam = ((real_T *)
    &CPS_heave_noAccelmeter_20221201_P);

  /* states (continuous) */
  {
    real_T *x = (real_T *) &CPS_heave_noAccelmeter_20221201_X;
    CPS_heave_noAccelmeter_20221201_M->contStates = (x);
    (void) memset((void *)&CPS_heave_noAccelmeter_20221201_X, 0,
                  sizeof(X_CPS_heave_noAccelmeter_20221201_T));
  }

  /* states (dwork) */
  CPS_heave_noAccelmeter_20221201_M->dwork = ((void *)
    &CPS_heave_noAccelmeter_20221201_DW);
  (void) memset((void *)&CPS_heave_noAccelmeter_20221201_DW, 0,
                sizeof(DW_CPS_heave_noAccelmeter_20221201_T));
  ...
  /* data type transition information */
  {
    ...
    (void) memset((char_T *) &dtInfo, 0,
                  sizeof(dtInfo));
    CPS_heave_noAccelmeter_20221201_M->SpecialInfo.mappingInfo = (&dtInfo);
  ...
  /* Initialize Sizes */
  CPS_heave_noAccelmeter_20221201_M->Sizes.numContStates = (4);/* Number of continuous states */
  CPS_heave_noAccelmeter_20221201_M->Sizes.numPeriodicContStates = (0);
                                      /* Number of periodic continuous states */
  CPS_heave_noAccelmeter_20221201_M->Sizes.numY = (0);/* Number of model outputs */
  CPS_heave_noAccelmeter_20221201_M->Sizes.numU = (0);/* Number of model inputs */
  CPS_heave_noAccelmeter_20221201_M->Sizes.sysDirFeedThru = (0);/* The model is not direct feedthrough */
