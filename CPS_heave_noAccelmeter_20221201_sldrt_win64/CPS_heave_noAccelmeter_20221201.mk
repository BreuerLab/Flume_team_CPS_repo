...
MODEL                := CPS_heave_noAccelmeter_20221201
MODULES              := CPS_heave_noAccelmeter_20221201_data.c CPS_heave_noAccelmeter_20221201_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := CPS_heave_noAccelmeter_20221201.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := CPS_heave_noAccelmeter_20221201_ref.rsp
...
# additional includes
REQ_INCLUDES += ;R:/ENG_Breuer_Shared/eericks1/Flume_team_CPS_repo;R:/ENG_Breuer_Shared/eericks1/Flume_team_CPS_repo/CPS_heave_noAccelmeter_20221201_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
